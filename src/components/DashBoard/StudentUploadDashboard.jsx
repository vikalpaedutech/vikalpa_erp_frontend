...
// import { Table, Button, Form, Row, Col, Card, Badge, Spinner, Alert, ButtonGroup, InputGroup } from "react-bootstrap";
...
//       "Status": item.uploadedCount === 0 ? "No Uploads" : "Has Uploads"
//     }));
...
//     doc.text(`Objective: ${objectiveId}`, 14, 25);
...
//     doc.autoTable({
//       head: [["#", "District", "School Name", "Total", "Uploaded", "Pending", "Completion %"]],
//       body: tableData,
//       startY: yPosition,
//       theme: "striped",
...
//             School-wise report for objective: <strong>{objectiveId}</strong> | Batch: <strong>{batch}</strong>
//           </small>
//         </div>
//         <ButtonGroup>
...
//                           <Badge bg="danger">No Uploads</Badge>
//                         ) : item.uploadedCount === item.totalStudents ? (
