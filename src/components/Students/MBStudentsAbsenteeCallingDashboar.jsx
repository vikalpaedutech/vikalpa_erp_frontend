...
//           'Personal Contact': student.personalContact || 'N/A',
//           'Parent Contact': student.parentContact || 'N/A',
//           'Contact 1': student.contact1 || 'N/A',
//           'Contact 2': student.contact2 || 'N/A',
//           'Other Contact': student.otherContact || 'N/A',
//           'Attendance Status': student.attendanceStatus || 'N/A',
...
//     // Summary section for Calling Report
//     const summaryData = [
//       { 'Report Type': 'CALLING DETAILED REPORT', 'Value': '' },
//       { 'Report Type': 'Generated On', 'Value': new Date().toLocaleString() },
//       { 'Report Type': 'Selected Date', 'Value': dashboardData?.filters?.date || 'All' },
//       { 'Report Type': 'Selected Batch', 'Value': dashboardData?.filters?.batch || 'All' },
//       { 'Report Type': 'Selected District', 'Value': dashboardData?.filters?.districtId || 'All' },
