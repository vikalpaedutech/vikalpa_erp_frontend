...
//         pdf.text(`Room No: ${r + 1} (Students ${r * studentsPerRoom + 1} to ${Math.min((r + 1) * studentsPerRoom, attendanceData.length)})`, w / 2, 41, { align: "center" });

//         // Draw table with student data
//         await drawTable(pdf, rooms[r], r + 1, 48);
...
//       pdf.text("Room No: ________", w / 2, 41, { align: "center" });
