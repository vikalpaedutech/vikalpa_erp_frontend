...
// import { studentAbsenteeCallingGamification } from "../service/Gamification.services.js";
// import {
...
export const AbsentCalling = ({
  ...
  const handleSubOptionsChange = async (studentSrn, selectedOption) => {
    setCallingStatus((prev) => ({
      ...prev,
      [studentSrn]: {
        ...prev[studentSrn],
    ...
    // ✅ Call update only after subOption is chosen
    if (selectedOption) {
      await updateCallingStatusInDb(studentSrn);
    }
  };
  ...
  // ❌ Removed useEffect that was re-triggering API calls for every callingStatus change
