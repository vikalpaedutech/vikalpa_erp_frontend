...
import TechConcerns from "../../components/Concern/TechConcerns";
import { TechConcernsResolution } from "../../components/Concern/TechConcernsResolution";

const TechConcernsLayout = () => {
...
//--------------------------------------
  ...
  return (
    <div>
      <TechConcernsResolution/>
    </div>
  );
};

export default TechConcernsLayout;
