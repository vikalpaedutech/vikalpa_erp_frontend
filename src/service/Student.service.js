...
//Updating student-absentee calling 
export const StudentAbsenteeCallingDashboard = async (reqBody) => {
    try {
     
        const response = await axios.post (`${API_BASE_URL}/api/mb-student-absentee-calling-dashboard`,reqBody)
